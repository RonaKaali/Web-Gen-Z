...
export const metadata: Metadata = {
  ...
  description:
    "Jasa pembuatan website, aplikasi, dan joki tugas programming untuk UMKM, cafe, dan usaha kecil. Mulai dari 500K! Biar kamu fokus bisnis, urusan website biar kami.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Biar kamu fokus bisnis, urusan website biar kami. Mulai dari 500K! Jasa pembuatan website, aplikasi, dan joki tugas programming.",
  ...
  twitter: {
    ...
    title: "WEBSITE GEN Z — Jasa Pembuatan Website & Aplikasi",
    description:
      "Biar kamu fokus bisnis, urusan website biar kami. Mulai dari 500K!",
    images: ["/logo.png"],
  },
  robots: {
    index: true,
